...
if __name__ == '__main__':
    ...
    smpl_seq_path = os.path.join('output', args.exp_name, 'smpl_seq.pkl')
    
    smpl_seq = load_smpl_seq(smpl_seq_path, gender=args.gender, straighten_hands=False)
    
    # Create the output directory
    subj_name = os.path.dirname(smpl_seq_path).split('/')[-1]
    subj_dir = os.path.join(args.out_dir, subj_name)
    os.makedirs(subj_dir, exist_ok=True)
    pkl_path = os.path.join(subj_dir, 'skel_seq.pkl')  
